...
enum RoleMessageEnum: string
{
    ...
    case FOR_NEW_COMERS = "Переходи в канал role чтобы выбрать роль, а так же ознакомься с правилами сервера(ваще тут анархия)\nТак же я слышал что бот хранит в себе тайны которую так никто и не раскрыл, может быть ты будешь первым?";
    case FOOTER = '⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀K3rik fmy ❤️';
}
